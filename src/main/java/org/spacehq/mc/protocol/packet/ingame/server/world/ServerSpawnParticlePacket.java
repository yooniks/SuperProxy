...
public class ServerSpawnParticlePacket implements Packet {
  ...
  public ServerSpawnParticlePacket(final Particle particle, final boolean longDistance,
      final float x, final float y, final float z, final float offsetX, final float offsetY,
      final float offsetZ, final float velocityOffset, final int amount, final int... data) {
