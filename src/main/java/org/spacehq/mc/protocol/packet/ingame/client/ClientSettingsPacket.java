...
public class ClientSettingsPacket implements Packet {
  ...
  public ClientSettingsPacket(final String locale, final int renderDistance,
      final ChatVisibility chatVisibility, final boolean chatColors,
      final SkinPart... visibleParts) {
    this.locale = locale;
