...
public class ServerSpawnPlayerPacket implements Packet {
  ...
  public ServerSpawnPlayerPacket(final int entityId, final UUID uuid, final double x,
      final double y, final double z, final float yaw, final float pitch, final int currentItem,
