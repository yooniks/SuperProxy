...
public class ServerEntityTeleportPacket implements Packet {
  ...
  public ServerEntityTeleportPacket(final int entityId, final double x, final double y,
      final double z, final float yaw, final float pitch, final boolean onGround) {
