...
public class ClientPlayerPlaceBlockPacket implements Packet {
  ...
  public ClientPlayerPlaceBlockPacket(final Position position, final Face face,
      final ItemStack held, final float cursorX, final float cursorY, final float cursorZ) {
