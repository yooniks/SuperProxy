...
public class TcpClientSession extends TcpSession {
  ...
  public TcpClientSession(final String host, final int port, final PacketProtocol protocol,
      final Client client, final Proxy proxy) {
    ...
    try {
      ...
      bootstrap.handler(new ChannelInitializer<Channel>() {
        public void initChannel(final Channel channel) throws Exception {
          TcpClientSession.this.getPacketProtocol()
              .newClientSession(TcpClientSession.this.client, TcpClientSession.this);
          ...
          .option(ChannelOption.CONNECT_TIMEOUT_MILLIS, this.getConnectTimeout() * 1000);
        ...
        public void run() {
          try {
            ...
            try {
              ...
              final String[] result = new InitialDirContext(environment).getAttributes(
                  TcpClientSession.this.getPacketProtocol().getSRVRecordPrefix() + "._tcp." + host,
