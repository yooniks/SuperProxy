...
public class ServerPlayerAbilitiesPacket implements Packet {
  ...
  public ServerPlayerAbilitiesPacket(final boolean invincible, final boolean canFly,
      final boolean flying, final boolean creative, final float flySpeed, final float walkSpeed) {
