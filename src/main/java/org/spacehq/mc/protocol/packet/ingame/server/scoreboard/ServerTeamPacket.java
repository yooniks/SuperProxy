...
public class ServerTeamPacket implements Packet {
  ...
  public ServerTeamPacket(final String name, final String displayName, final String prefix,
      final String suffix, final boolean friendlyFire, final boolean seeFriendlyInvisibles,
  ...
  public ServerTeamPacket(final String name, final String displayName, final String prefix,
      final String suffix, final boolean friendlyFire, final boolean seeFriendlyInvisibles,
      final NameTagVisibility nameTagVisibility, final TeamColor color, final String[] players) {
    this.name = name;
    this.displayName = displayName;
    this.prefix = prefix;
    this.suffix = suffix;
