...
public class StatusResponsePacket implements Packet {
  ...
  public void read(final NetInput in) throws IOException {
    ...
    final VersionInfo version = new VersionInfo(ver.get("name").getAsString(),
        ver.get("protocol").getAsInt());
    ...
    final PlayerInfo players = new PlayerInfo(plrs.get("max").getAsInt(),
        plrs.get("online").getAsInt(), profiles);
