...
public class ServerJoinGamePacket implements Packet {
  ...
  public ServerJoinGamePacket(final int entityId, final boolean hardcore, final GameMode gamemode,
      final int dimension, final Difficulty difficulty, final int maxPlayers,
      final WorldType worldType, final boolean reducedDebugInfo) {
