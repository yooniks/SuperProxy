...
public class AttributeModifier {
  ...
  public AttributeModifier(final ModifierType type, final double amount,
  ...
  public AttributeModifier(final UUID uuid, final double amount,
      final ModifierOperation operation) {
  ...
  public boolean equals(final Object o) {
    ...
    return Double.compare(that.amount, this.amount) == 0 && this.operation == that.operation
        && this.type == that.type;
  }
