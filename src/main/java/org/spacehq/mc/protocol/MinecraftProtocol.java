...
public class MinecraftProtocol extends PacketProtocol {
  ...
  public MinecraftProtocol(final String username, final String using, final boolean token)
      throws RequestException {
    this(username, using, token, Proxy.NO_PROXY);
  }

  public MinecraftProtocol(final String username, final String using, final boolean token,
      final Proxy authProxy) throws RequestException {
    this(SubProtocol.LOGIN);
  ...
  protected void setSubProtocol(final SubProtocol subProtocol, final boolean client,
