...
public class MinecraftConstants {
  ...
  public static final String SERVER_INFO_HANDLER_KEY = "listener-info-handler";
  public static final String SERVER_PING_TIME_HANDLER_KEY = "listener-ping-time-handler";
