...
public class Chunk {
  ...
  public Chunk(final boolean skylight) {
    this(new ShortArray3d(4096), new NibbleArray3d(4096),
        skylight ? new NibbleArray3d(4096) : null);
  }

  public Chunk(final ShortArray3d blocks, final NibbleArray3d blocklight,
      final NibbleArray3d skylight) {
    this.blocks = blocks;
