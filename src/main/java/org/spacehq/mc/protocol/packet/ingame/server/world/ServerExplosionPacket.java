...
public class ServerExplosionPacket implements Packet {
  ...
  public ServerExplosionPacket(final float x, final float y, final float z, final float radius,
      final List<ExplodedBlockRecord> exploded, final float pushX, final float pushY,
      final float pushZ) {
    this.x = x;
    this.y = y;
    this.z = z;
