...
public class TranslationMessage extends Message {
  ...
  public TranslationMessage clone() {
    return (TranslationMessage) new TranslationMessage(this.getTranslationKey(),
        this.getTranslationParams()).setStyle(this.getStyle().clone()).setExtra(this.getExtra());
  }
  ...
  public boolean equals(final Object o) {
    ...
    return this.translationKey.equals(that.translationKey) && Arrays
        .equals(this.translationParams, that.translationParams);
  }
