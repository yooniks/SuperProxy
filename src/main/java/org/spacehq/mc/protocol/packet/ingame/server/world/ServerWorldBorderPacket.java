...
public class ServerWorldBorderPacket implements Packet {
  ...
  public ServerWorldBorderPacket(final double centerX, final double centerY, final double oldRadius,
      final double newRadius, final long speed, final int portalTeleportBoundary,
      final int warningTime, final int warningBlocks) {
