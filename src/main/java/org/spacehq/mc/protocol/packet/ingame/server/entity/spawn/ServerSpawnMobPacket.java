...
public class ServerSpawnMobPacket implements Packet {
  ...
  public ServerSpawnMobPacket(final int entityId, final MobType type, final double x,
      final double y, final double z, final float yaw, final float pitch, final float headYaw,
      final double motX, final double motY, final double motZ, final EntityMetadata[] metadata) {
