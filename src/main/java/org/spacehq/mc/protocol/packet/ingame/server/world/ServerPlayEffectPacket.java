...
public class ServerPlayEffectPacket implements Packet {
  ...
  public ServerPlayEffectPacket(final WorldEffect effect, final Position position,
      final WorldEffectData data) {
    this(effect, position, data, false);
  }

  public ServerPlayEffectPacket(final WorldEffect effect, final Position position,
      final WorldEffectData data, final boolean broadcast) {
    this.effect = effect;
