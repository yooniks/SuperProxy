...
public class ServerWorldBorderPacket implements Packet
{
    ...
    public ServerWorldBorderPacket(final double radius) {
        this.action = WorldBorderAction.SET_SIZE;
        this.radius = radius;
    }
    
    public ServerWorldBorderPacket(final double oldRadius, final double newRadius, final long speed) {
    ...
    public ServerWorldBorderPacket(final double centerX, final double centerY) {
        this.action = WorldBorderAction.SET_CENTER;
        this.centerX = centerX;
        this.centerY = centerY;
    }
    
    public ServerWorldBorderPacket(final double centerX, final double centerY, final double oldRadius, final double newRadius, final long speed, final int portalTeleportBoundary, final int warningTime, final int warningBlocks) {
    ...
    public ServerWorldBorderPacket(final int warning, final boolean time) {
        if (time) {
