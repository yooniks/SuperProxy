...
public class ServerPlayerPositionRotationPacket implements Packet {
  ...
  public ServerPlayerPositionRotationPacket(final double x, final double y, final double z,
      final float yaw, final float pitch) {
    this(x, y, z, yaw, pitch, new PositionElement[0]);
  }

  public ServerPlayerPositionRotationPacket(final double x, final double y, final double z,
      final float yaw, final float pitch, final PositionElement... relative) {
    this.x = x;
    this.y = y;
    this.z = z;
    this.yaw = yaw;
